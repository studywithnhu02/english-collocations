...
test('new vocabulary modules are wired and table API exists',()=>{for(const token of ['normalizeVocabularyRow','window.PreviewTable=','version:3','data-auto-fill','d9c1f43','vocabulary-ui.js?v=1','smart-ingestion.js?v=1','quiz-ui.js?v=1','focus-ui.js?v=1','family-ui.js?v=1','coverage-ui.js?v=1','coach-ui.js?v=1','anki-export.js?v=1','print-export.js?v=1'])assert.ok(app.includes(token),token)});
